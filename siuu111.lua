...
if BF then
	...
	function library:Window(name,game)
		...
		NameHub.Text = "<font color=\"rgb(".. math.floor(ColorII.R * 255) .. "," .. math.floor(ColorII.G * 255) .. ",".. math.floor(ColorII.B * 255) ..")\"> " .. Arces-LT .. " </font> Hub | " .. game
